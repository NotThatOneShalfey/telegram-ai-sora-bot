...
public enum PriceCoefficient {
    ...
    AMBASSADOR_SEEDANCE_COEFFICIENT(1.1f),
    NON_AMBASSADOR_SEEDANCE_COEFFICIENT(1.5f),
    AMBASSADOR_ELEVENLABS_COEFFICIENT(1.5f),
    NON_AMBASSADOR_ELEVENLABS_COEFFICIENT(2f),
