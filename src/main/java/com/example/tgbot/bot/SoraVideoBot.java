...
//                        switch (session.getState()) {
//                            case WAITING_FOR_TEXT_DESCRIPTION:
//                                handleTextDescriptionForMusic(chatId, message.getText(), session);
//                                break;
//                            default:
//                                sendMainMenu(chatId, "Я не понял вашу команду. Пожалуйста, выберите действие из меню.", session);
//                        }
...
//        User user = userService.findOrCreateUser(chatId, userName, referral);
...
//            case "package_100":
//                sendInvoice(chatId, PaidPackageButton.PACKAGE_100);
//                break;
//            case "package_550":
//                sendInvoice(chatId, PaidPackageButton.PACKAGE_550);
//                break;
//            case "package_1200":
//                sendInvoice(chatId, PaidPackageButton.PACKAGE_1200);
//                break;
//            case "package_6500":
//                sendInvoice(chatId, PaidPackageButton.PACKAGE_6500);
//                break;
//            case "package_gift":
...
//                break;
//            case "pop-genre":
//                session.setSelectedFormat(SunoMusicGenreButton.POP);
//                session.setState(BotState.WAITING_FOR_TEXT_DESCRIPTION);
//                sendDescriptionPrompt(chatId, user.getBalance(), session);
//                break;
//            case "rap-genre":
//                session.setSelectedFormat(SunoMusicGenreButton.RAP);
//                session.setState(BotState.WAITING_FOR_TEXT_DESCRIPTION);
//                sendDescriptionPrompt(chatId, user.getBalance(), session);
//                break;
//            case "disco-genre":
//                session.setSelectedFormat(SunoMusicGenreButton.DISCO);
//                session.setState(BotState.WAITING_FOR_TEXT_DESCRIPTION);
//                sendDescriptionPrompt(chatId, user.getBalance(), session);
//                break;
//            case "shanson-genre":
//                session.setSelectedFormat(SunoMusicGenreButton.SHANSON);
//                session.setState(BotState.WAITING_FOR_TEXT_DESCRIPTION);
//                sendDescriptionPrompt(chatId, user.getBalance(), session);
//                break;
//            case "rock-genre":
//                session.setSelectedFormat(SunoMusicGenreButton.ROCK);
//                session.setState(BotState.WAITING_FOR_TEXT_DESCRIPTION);
//                sendDescriptionPrompt(chatId, user.getBalance(), session);
//                break;
//            case "classic-genre":
//                session.setSelectedFormat(SunoMusicGenreButton.CLASSIC);
//                session.setState(BotState.WAITING_FOR_TEXT_DESCRIPTION);
//                sendDescriptionPrompt(chatId, user.getBalance(), session);
//                break;
//            case "electro-genre":
//                session.setSelectedFormat(SunoMusicGenreButton.ELECTRO);
//                session.setState(BotState.WAITING_FOR_TEXT_DESCRIPTION);
//                sendDescriptionPrompt(chatId, user.getBalance(), session);
//                break;
//            case "jazz-genre":
//                session.setSelectedFormat(SunoMusicGenreButton.JAZZ);
//                session.setState(BotState.WAITING_FOR_TEXT_DESCRIPTION);
//                sendDescriptionPrompt(chatId, user.getBalance(), session);
//                break;
//            case "narodnaya-genre":
//                session.setSelectedFormat(SunoMusicGenreButton.NARODNAYA);
//                session.setState(BotState.WAITING_FOR_TEXT_DESCRIPTION);
//                sendDescriptionPrompt(chatId, user.getBalance(), session);
//                break;
//            case "acoustic-genre":
//                session.setSelectedFormat(SunoMusicGenreButton.ACCOUSTIC);
//                session.setState(BotState.WAITING_FOR_TEXT_DESCRIPTION);
//                sendDescriptionPrompt(chatId, user.getBalance(), session);
//                break;
//            case "menu_back":
...
//        User user = userService.findUser(chatId);
//        userService.addBalance(user, PaidPackageButton.getPackagePriceByName(packageName));
//    }
//
//
...
//            if (session.getSelectedFormat() instanceof SunoMusicGenreButton g) {
//                selectedGenre = g.getButtonText();
//            }
//            text = "✅ Песня готова!\n\n" + "Жанр: " + selectedGenre + "\n" + "\uD83D\uDCBE Описание:\n > " + prompt;
//        } else {
//            text = "✅ Видео готово!\n\uD83D\uDCBE Промпт:\n > " + prompt;
...
//                    "\n" +
//                    "\uD83E\uDE991 монета = 1 рубль \uD83E\uDE99";
//            case NANO_BANANA -> text = "\uD83D\uDDBC Nano Banana Pro — генерация изображений\n" +
//                    "\n" +
//                    "Отправь:\n" +
//                    "\n" +
...
//                    selectedGenre = g.getButtonText();
//                }
//                text = "Отлично, с жанром определились!\n" +
...
//        sendAfterFileGeneration(chatId, session);
//        session.setState(BotState.INITIAL);
//        videoGenerationService.generateMusicFromPrompt(session, prompt)
//                .subscribe(
//                        urlList -> {
//                            try {
...
//            rows.add(List.of(createButton("%d монет - %d ₽".formatted(p.getPackageAmount(), p.getPackagePrice()), p.toString())));
//        }
...
//                prevGenre = genre;
//            } else {
//                rows.add(List.of(createButton(prevGenre.getButtonText(), prevGenre.getButtonCallback()), createButton(genre.getButtonText(), genre.getButtonCallback())));
//                prevGenre = null;
//            }
//        }
//        rows.add(List.of(createButton("Главное меню", "menu_back")));
...
//    }
//
//    private void sendInvoice(Long chatId, PaidPackageButton pack) {
