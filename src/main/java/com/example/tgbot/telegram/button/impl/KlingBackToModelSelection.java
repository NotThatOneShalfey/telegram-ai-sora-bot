...
import static com.example.tgbot.telegram.button.ButtonType.KLING_BACK_TO_MODEL_SELECTION;

@Component
@RequiredArgsConstructor
public class KlingBackToModelSelection implements IButton {

    @Lazy
    private final PanelRegistry panelRegistry;
    @Override
    public ButtonType getLabel() {
        return KLING_BACK_TO_MODEL_SELECTION;
    }
